...
from latentdoc.model.vision_encoder.resnet import build_test_transforms
...
def infer_from_arg():
    ...
    args.model_weight_path = '/home/yuhaiyang/zlw/LatentDoc/exps/resnet_deepspeed_cosine_with_restarts_self/checkpoint-1500'
