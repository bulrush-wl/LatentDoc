...
class LatentDocOPTModel(OPTModel):
    config_class = LatentDocConfig

    def __init__(self, config: OPTConfig):
        super(LatentDocOPTModel, self).__init__(config)


        # self.vision_tower = build_sam_vit_b()
        self.vision_tower = CLIPVisionModel.from_pretrained('/home/yuhaiyang/zlw/pretrained_weight/models--openai--clip-vit-large-patch14')
    ...
    def initialize_vision_modules(
        ...
        image_processor = CLIPImageProcessor.from_pretrained('/home/yuhaiyang/zlw/pretrained_weight/models--openai--clip-vit-large-patch14')
    ...
    def forward(
        ...
        if vision_tower is not None and (input_ids.shape[1] != 1 or self.training) and images is not None:
            ...
            #         image_feature_final = select_hidden_state[:, 1:]  # 256*1024
            ...
            image_features = vision_tower(images, output_hidden_states=True)
            select_hidden_state = image_forward_out.hidden_states[vision_select_layer]
            image_features = select_hidden_state[:, 1:]  # 256*1024
