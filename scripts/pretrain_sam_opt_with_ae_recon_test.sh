...
deepspeed   --include "localhost:2" --master_port 29502  /home/yuhaiyang/zyl/code/LatentDoc/latentdoc/train/train_sam_opt_1024_with_ae_recon.py   \
            --deepspeed /home/yuhaiyang/zyl/code/LatentDoc/zero_config/zero0.json \
            --model_type  sam_opt_1024_with_ae_with_projector_down4_recon_test  \
            ...
            --learning_rate 5e-5        \
            --datasets  test    \
            --output_dir /home/yuhaiyang/zyl/code/LatentDoc/exps/recon_yanzheng    \